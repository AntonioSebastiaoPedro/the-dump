...
BONUS_RENDER_FILES = $(RENDER_FILES:.c=_bonus.c) minimap_bonus.c update_weapon_bonus.c draw_weapon_bonus.c door_bonus.c door_helped_bonus.c draw_floor_ceiling_pixel_bonus.c put_fl_cl_bonus.c mira_bonus.c hud_bonus.c
